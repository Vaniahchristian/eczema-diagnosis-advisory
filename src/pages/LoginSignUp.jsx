...
const LoginSignUp = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1582719478250-9ef3f9e18e3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80')` }}>
      {/* Overlay */}
